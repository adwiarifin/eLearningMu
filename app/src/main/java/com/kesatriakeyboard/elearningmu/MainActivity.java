...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void GetStringAndJSONRequest(String page1, String page2) {
        mUserDataList.clear();
        numberOfRequestCompleted = 0;
        VolleyLog.DEBUG = true;
        RequestQueue queue = SingletonRequestQueue.getInstance(getApplicationContext()).getRequestQueue();
        String uri_page_one = String.format(BASE_URL + "/api/users?page=%1$s", page1);
        String uri_page_two = String.format(BASE_URL + "/api/users?page=%1$s", page2);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, uri_page_one, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                mUserDataList.addAll(userList.data);
                ++numberOfRequestCompleted;
            }
        }, errorListener) {
            @Override
        ...
        queue.addRequestFinishedListener(new RequestQueue.RequestFinishedListener<Object>() {
            ...
            public void onRequestFinished(Request<Object> request) {
                try {
                    ...
                    Log.e("FATAL ERROR", "UnsupportedEncodingException");
                    e.printStackTrace();
                } catch (Exception e) {
                    Log.e("FATAL ERROR", "General Error");
                    e.printStackTrace();
                }

                if (numberOfRequestCompleted == 2) {
                    numberOfRequestCompleted = 0;
    ...
    private void POSTStringAndJSONRequest() {
        ...
        final JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(uri, jsonObject, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                VolleyLog.wtf(response.toString(), "utf-8");
        ...
        StringRequest stringRequestPOSTJSON = new StringRequest(Request.Method.POST, uri, new Response.Listener<String>() {
            ...
            public byte[] getBody() throws AuthFailureError {
                ...
                try {
                    ...
                    jsonObject.put("job", "To implement Volley in android Application");
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void customRequest() {
        ...
        GsonRequest gsonRequest = new GsonRequest(url, UserList.class, headers, new Response.Listener<UserList>() {
            @Override
            public void onResponse(UserList response) {
                mUserDataList.addAll(response.data);
                startActivity(new Intent(MainActivity.this, RecyclerViewActivity.class).putExtra("users", mUserDataList));
            }
        }, errorListener);
